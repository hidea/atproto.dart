...
mixin _$LexString {
  ...
  int? get maxGraphemes => throw _privateConstructorUsedError;
  @JsonKey(name: 'enum')
...
/// @nodoc
abstract class $LexStringCopyWith<$Res> {
...
/// @nodoc
class _$LexStringCopyWithImpl<$Res, $Val extends LexString>
    implements $LexStringCopyWith<$Res> {
  _$LexStringCopyWithImpl(this._value, this._then);
